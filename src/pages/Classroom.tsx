        ...
        <div className="container max-w-5xl mx-auto mt-12">
          <div className="text-center mb-12 opacity-0 animate-fade-in" style={{ animationFillMode: 'forwards' }}>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-veri">Google Classroom</span> Integration
            </h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Connect your Google Classroom to VeriWrite for seamless document management 
              ...
              <ol className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-muted-foreground pt-0.5">
                    Sign in with your Google account and grant VeriWrite access to your Google Classroom.
                  </p>
                </li>
                <li className="flex gap-3">
